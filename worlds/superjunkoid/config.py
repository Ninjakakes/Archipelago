...
def load_library() -> None:
    ...
    logging.info("loading super_junkoid_randomizer library...")
    for file in zip_file.namelist():
        if file.startswith('superjunkoid/super_junkoid_randomizer/'):
            new_path = file[13:]
...
if is_apworld():
    ...
    lib_dir = os.path.join("lib", "super_junkoid_randomizer")
